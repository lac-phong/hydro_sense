    ...
    <div className="flex">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="col-span-7 place-self-center">
          ...
          <h1 className="name_text_container text-[#BBC275] mb-4 text-6xl font-bold"><span className="gradient-text bg-clip-text bg-gradient-to-r from-green-600 to-green-300">NAME{" "}</span></h1>
                
          <div className="button-container">
            <button className="custom-button">CREATE NEW SHEET</button>
            <button className="custom-button">EDIT EXISTING SHEET</button>
            ...
            <button className="custom-additional-button"><span className="about-text">EXISTIN SHEETS</span></button>
          </div>
